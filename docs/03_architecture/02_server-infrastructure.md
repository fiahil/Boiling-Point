...
-- Per-round detail for analytics
CREATE TABLE game_rounds (
    game_id          UUID REFERENCES games(id),
    round_number     SMALLINT NOT NULL,
    boiling_point    SMALLINT NOT NULL,   -- the hidden threshold, revealed post-game
    exploded         BOOLEAN NOT NULL,    -- shared loss: no single player is blamed
